...
public final class Config {
    ...
    public static final int SERVER_CANNON_START_POINT_X = 560;
    public static final int SERVER_CANNON_START_POINT_Y = 705;
    public static final double CANNON_WIDTH = 220;
    public static final double CANNON_HEIGHT = 170;
    public static double CENTER_OF_WHEEL_ON_IMAGE_X = 0.57 * CANNON_WIDTH;
    public static double CENTER_OF_WHEEL_ON_IMAGE_Y = 0.66 * CANNON_HEIGHT;
